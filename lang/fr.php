...
const VOTES_DASHBOARD_ADD_CARD_TITLE = "Ajouter un site de votes";
const VOTES_DASHBOARD_ADD_PLACEHOLDER_TITLE = "Titre du site de votes";
const VOTES_DASHBOARD_ADD_PLACEHOLDER_TIME = "Temps entre chaques votes en minutes (exemple: 90)";
const VOTES_DASHBOARD_ADD_PLACEHOLDER_ID_UNIQUE = "Id unique de votre site (exemple: 2154)";
const VOTES_DASHBOARD_ADD_PLACEHOLDER_URL = "Liens vers la page de votes";
const VOTES_DASHBOARD_ADD_PLACEHOLDER_REWARDS = "Récompenses";
const VOTES_DASHBOARD_ADD_BTN_SITESCOMP = "Afficher les sites de votes compatibles";
const VOTES_DASHBOARD_ADD_BTN_TESTID = "Tester l'Id";
const VOTES_DASHBOARD_ADD_SITESCOMP_MODAL_TITLE = "Liste des sites de votes compatibles";


/* Liste des sites */

const VOTES_DASHBOARD_LISTE_TITLE = "Cliquez sur le site que vous souhaitez éditer";
